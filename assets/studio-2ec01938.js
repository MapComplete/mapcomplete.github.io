...
iftrue: Do not write 'change_within_x_m' and do not indicate that this was done by survey`,type:"boolean"}},additionalProperties:!1},"Partial<any>":{type:"object",additionalProperties:!1},RasterLayerProperties:{description:"This class has grown beyond the point of only containing Raster Layers",type:"object",properties:{name:{description:"The name of the imagery source",anyOf:[{$ref:"#/definitions/Record<string,string>"},{type:"string"}]},isOverlay:{type:"boolean"},id:{type:"string"},url:{type:"string"},category:{type:"string"},type:{type:"string"},style:{type:"string"},attribution:{type:"object",properties:{url:{type:"string"},text:{type:"string"},html:{type:"string"},required:{type:"boolean"}}},min_zoom:{type:"number"},max_zoom:{type:"number"},best:{type:"boolean"}},required:["id","name","url"],additionalProperties:!1}},Ml="http://json-schema.org/draft-07/schema#",Ol=!1,Nl={description:Sl,type:Il,properties:jl,required:Jl,definitions:Wl,$schema:Ml,additionalProperties:Ol};function Dl(o){let e,t,n=!o[2]&&ai();return{c(){e=q("div"),n&&n.c(),k(e,"class","h-full w-full")},m(i,s){b(i,e,s),n&&n.m(e,null),o[7](e),t=!0},p(i,s){i[2]?n&&(K(),u(n,1,1,()=>{n=null}),ee()):n?s&4&&f(n,1):(n=ai(),n.c(),f(n,1),n.m(e,null))},i(i){t||(f(n),t=!0)},o(i){u(n),t=!1},d(i){i&&y(e),n&&n.d(),o[7](null)}}}function Fl(o){let e,t,n;return{c(){e=q("textarea"),k(e,"class","w-full"),k(e,"rows","25")},m(i,s){b(i,e,s),ze(e,o[3]),t||(n=ne(e,"input",o[6]),t=!0)},p(i,s){s&8&&ze(e,i[3])},i:E,o:E,d(i){i&&y(e),t=!1,n()}}}function ai(o){let e,t,n;return t=new jo({}),{c(){e=q("div"),x(t.$$.fragment),k(e,"class","align-center flex h-full w-full items-center")},m(i,s){b(i,e,s),C(t,e,null),n=!0},i(i){n||(f(t.$$.fragment,i),n=!0)},o(i){u(t.$$.fragment,i),n=!1},d(i){i&&y(e),R(t)}}}function Ll(o){let e,t,n,i;const s=[Fl,Dl],a=[];function l(r,h){return r[1]?0:1}return e=l(o),t=a[e]=s[e](o),{c(){t.c(),n=ae()},m(r,h){a[e].m(r,h),b(r,n,h),i=!0},p(r,[h]){let d=e;e=l(r),e===d?a[e].p(r,h):(K(),u(a[d],1,1,()=>{a[d]=null}),ee(),t=a[e],t?t.p(r,h):(t=a[e]=s[e](r),t.c()),f(t,1),t.m(n.parentNode,n))},i(r){i||(f(t),i=!0)},o(r){u(t),i=!1},d(r){a[e].d(r),r&&y(n)}}}function Pl(o,e,t){let n,{state:i}=e,s=i.configuration.sync(v=>JSON.stringify(v,null,"  "),[],v=>{try{return JSON.parse(v)}catch{console.error("Could not parse",v);return}});oe(o,s,v=>t(3,n=v));let a,l,r,h;function d(){try{const v=JSON.parse(r.getValue());i.configuration.setData(v)}catch(v){console.error(v)}}_t(()=>{const v=w=>{w.key==="s"&&(w.ctrlKey||w.metaKey)&&(w.preventDefault(),d())};return window.addEventListener("keydown",v),()=>window.removeEventListener("keydown",v)});let p=!1,c=!1;_t(async()=>{var J,W,U,T,P,I;const v=await Io(()=>import("./editor.main-db6adf10.js").then(F=>F.e),["./editor.main-db6adf10.js","./FloatOver-f8fe65c1.js","./index-39d6b045.js","./UIEventSource-eb9941c6.js","./tw-merge-ce98ffa8.js","./LocalStorageSource-6a9b3893.js","./tw-join-70ce42f3.js","./AccordionSingle-9ce646ef.js","./ThemeViewStateHashActor-68d54d64.js","./LayerConfig-889b9f3c.js","./Constants-c1d250c3.js","./Marker-e65c9fb8.js","./Loading-b1d11f8a.js","./Loading-90cc5112.js","./Dropdown-729d1545.js","./ValidatedInput-81ee928f.js","./Checkbox-54fbd1b1.js","./BackButton-a093ce0c.js","./Login-60d4f5df.js","./ThemeViewStateHashActor-52887e51.css","./editor-a89423dd.css"],import.meta.url);si.config({monaco:v.default});try{l=await si.init()}catch(F){console.error("Could not load Monaco Editor, falling back",F),t(1,p=!0)}let w;i instanceof Ai?w="https://mapcomplete.org/schemas/layerconfig.json":w="https://mapcomplete.org/schemas/layoutconfig.json",(U=(W=(J=l==null?void 0:l.languages)==null?void 0:J.json)==null?void 0:W.jsonDefaults)==null||U.setDiagnosticsOptions({validate:!0,schemas:[{uri:w,fileMatch:["file.json"],schema:w==="https://mapcomplete.org/schemas/layerconfig.json"?Al:Nl}]});let $=(T=l==null?void 0:l.Uri)==null?void 0:T.parse("inmemory://inmemory/file.json");try{h=(P=l==null?void 0:l.editor)==null?void 0:P.createModel(JSON.stringify(i.configuration.data,null,"  "),"json",$)}catch(F){console.error("Could not create model in MOnaco Editor",F),t(1,p=!0)}r=(I=l==null?void 0:l.editor)==null?void 0:I.create(a,{model:h,automaticLayout:!0});let N;r==null||r.onDidChangeModelContent(()=>{clearTimeout(N),N=setTimeout(()=>{d()},500)}),t(2,c=!0)}),dt(()=>{r&&r.dispose(),h&&h.dispose()});function g(){n=this.value,s.set(n)}function _(v){Me[v?"unshift":"push"](()=>{a=v,t(0,a)})}return o.$$set=v=>{"state"in v&&t(5,i=v.state)},[a,p,c,n,s,i,g,_]}class Li extends pe{constructor(e){super(),ce(this,e,Pl,Ll,fe,{state:5})}}function El(o){let e,t,n,i,s;return t=new yi({props:{class:"h-6 w-6"}}),{c(){e=q("div"),x(t.$$.fragment),n=M(`
      ...
      might have a backup`,n=S(),x(i.$$.fragment),k(e,"class","flex flex-col")},m(a,l){b(a,e,l),m(e,t),m(e,n),C(i,e,null),s=!0},p(a,l){const r={};l&33&&(r.$$scope={dirty:l,ctx:a}),i.$set(r)},i(a){s||(f(i.$$.fragment,a),s=!0)},o(a){u(i.$$.fragment,a),s=!1},d(a){a&&y(e),R(i)}}}function Bl(o){let e,t,n,i,s;return t=new yi({props:{class:"h-6 w-6"}}),{c(){e=q("div"),x(t.$$.fragment),n=M(`
...
//# sourceMappingURL=studio-2ec01938.js.map
